        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2><b style="color:black">Quản lý sản phẩm</b></h2>
                        </div>
                        <div class="col-sm-6">
                        	<a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span><b>Xóa</b></span></a>	
                            <a href="#addEmployeeModal"  class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span><b>Thêm sản phẩm</b></span></a>
